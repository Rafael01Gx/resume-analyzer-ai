  ...
  template: `
    <main class="bg-[url('/images/bg-main.svg')] bg-cover transition-['scroll'] duration-500">
      ...
      <section class="main-section">
        @if(isAuthenticated()){        <div class="page-heading py-16">
        ...
        <div class="resumes-section">
          ...
          <div class="page-heading py-16 text-center">
            ...
            <h2 class="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Receba análises detalhadas, sugestões de melhoria e feedback personalizado para destacar seu perfil no mercado de trabalho.
              Nossa IA examina cada seção do seu currículo e oferece insights valiosos para potencializar suas chances de sucesso.
            </h2>
